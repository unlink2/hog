...
#define hog_warn(...)                                                         \
  hog_log_fprintf(stderr, HOG_LOG_LEVEL_WARN, __VA_ARGS__)
#define hog_info(...)                                                         \
  hog_log_fprintf(stderr, HOG_LOG_LEVEL_INFO, __VA_ARGS__)
#define hog_error(...)                                                        \
  hog_log_fprintf(stderr, HOG_LOG_LEVEL_ERROR, __VA_ARGS__)
